...
use Kiboko\Component\Pipeline\Plumbing\StepGroup;
use Kiboko\Component\Pipeline\Plumbing\StepGroupInterface;
use Kiboko\Component\Pipeline\Plumbing\StepInterface;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;

class StepGroupSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType(StepGroup::class);
    }
    ...
    function it_can_fork_steps(
        StepInterface $step1,
        StepInterface $step2,
        StepInterface $step3
    ) {
        $this->fork($step1, $step2, $step3)
            ->shouldReturnAnInstanceOf(StepGroupInterface::class);
    }
